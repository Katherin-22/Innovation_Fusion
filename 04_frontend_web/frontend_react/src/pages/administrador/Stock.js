    ...
    <div className="header">    
        <div className="row custom-header">
            ...
            <div className="col-9 d-flex align-items-end px-1 gap-2 w-50">
                <a href="./REGISTRO_PRODUCTO.HTML" className="btn custom-btn btn-light">Registrar Categoria</a>
                    ...
                    <thead>
                        ...
                        {stock.map((stock) => (
                            ...
                            <td><a href="./REGISTRO_PRODUCTO.HTML" id="boton_agregar" className="btn btn-light">Editar</a>
                                ...
                                <a href="#" id="boton_eliminar" className="btn btn-light">Agregar Tallas/colores</a>
                            </td>
